# User-Space Driver with Parallel packet Assembling and Adaptive Algorithm
This is a best upgrade version of the repository "User-Space Driver with Assembler", we integrated parallel assembling method in the user-space driver to get a higher data throughput in small-packet-intensive senarios. Besides, we integrated an adaptive assembling size method to cope with senarios with abrupt data traffic.
